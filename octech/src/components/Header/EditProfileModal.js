...
const EditProfileModal = ({setShowEditProfile}) =>{
    ...
    <div>
        ...
        />
        <TextField id="currentPassword" className="field" variant="outlined" label="Current Password"  placeholder="Enter Your Current Password" helperText={!oldPassword ? "Current Password cannot be empty" : oldPasswordDoesNotMatch ? "Current Password incorrect" : ""} error ={!oldPassword | oldPasswordDoesNotMatch} value ={oldPassword} onChange={(event)=>{setOldPassword(event.target.value);if(oldPasswordDoesNotMatch) setOldPasswordDoesNotMatch(false)}} fullWidth InputLabelProps={{ shrink: true,}}
            InputProps={{
        ...
        >
        <Modal.Body>
            <TextField id="confirmPassword" className="field" variant="outlined" label="Confirm Password"  placeholder="Enter Your Password" helperText={!confirmPassword ? "Password cannot be empty" : confirmPasswordDoesNotMatch ? "Incorrect Password" : ""} error ={!confirmPassword | confirmPasswordDoesNotMatch} value ={confirmPassword} onChange={(event)=>{setConfirmPassword(event.target.value);if(confirmPasswordDoesNotMatch)setconfirmPasswordDoesNotMatch(false)}} fullWidth InputLabelProps={{ shrink: true,}}
                InputProps={{
