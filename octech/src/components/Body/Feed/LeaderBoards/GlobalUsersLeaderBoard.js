...
function GlobalUsersLeaderBoard({ match, setValue }) {
  ...
  return (
    ...
    <LeaderBoardComponent title="Global Users LeaderBoard" headers={['Name','Profile Points']} columns={['name', 'profilePoints']} limit={100} data={leaderboardData} highlightColumn={'email'} highlightColumnData={user.email} />
