  ...
  return (
    <div ref={ref} className="post" key={id}>
      ...
      {!loading ? <div>
        ...
        <center><Skeleton variant="text" width={"80%"} height={"40px"} animation="wave" style={{marginBottom: "20px"}}/></center>
        ...
        <center><Skeleton variant="text" width={"80%"} height={"40px"} animation="wave" /></center>
      </div>}
    </div>
  );
});
